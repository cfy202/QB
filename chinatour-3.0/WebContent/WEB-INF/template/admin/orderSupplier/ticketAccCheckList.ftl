...
<div class="md-overlay"></div>
    <div class="container-fluid" id="pcont">
        <div class="page-head">
            <h3>Air Ticket</h3>
            <div class="new"> <a class="btn pull-right " href="javascript:explorBill();" title="Export Bill"><i class="fa fa-share-square-o" ></i></a><a style="cursor:pointer;" href="javascript:void(0);" class="md-trigger"></a></div>
            <ol class="breadcrumb">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/supplierPrice/ticketAccCheckList.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
            ...
            "columnDefs" : [ {
				"render" : function(data, type, row) {
					...
					if(row.type==0){
						html+='<li><a href="accTicketCheck.jhtml?id='+data+'"><i class="fa fa-pencil"></i>View</a></li>'
					}
					html+='<li><a href="invoiceForTicket.jhtml?id='+data+'" target="_blank"><i class="fa fa-print"></i>Invoice</a></li>'
					html+='<li></ul></div>';
					return html;
                 },
				"targets" :12
		...
		function explorBill(){
			...
			html="invoiceNum="+invoiceNum+"&userName="+userName+"&agentName="+agentName+"&beginningDate="+beginningDate+"&endingDate="+endingDate+"&tempValue05="+tempValue05+"&deptName="+deptName+"&accRemarkOfOp="+accRemarkOfOp;
			html+="&type="+type+"&approveStatus="+approveStatus+"&ticketNo="+ticketNo+"&airline="+airline+"&tempValue04="+tempValue04+"&charge="+charge+"&amount="+amount+"&operatorFee="+operatorFee+"&card="+card+"&venderName="+venderName;
    		location.href="${base}/admin/supplierPrice/excelForAir.jhtml?"+html;
	}
</script>
</script>
</body>
