			 ...
			 <table>
			 	<tr>
			 		...
			 		<td class="noBorder">Year
			 			<select id="isAvailable" class="select2" name="accountDate" >
...
<div id="content">
	<h2 style="text-align:center;">CTS - ${deptName} Monthly Profit & Loss 文景假期月报表 </h2>
			...
			[#if flag==1||flag==""]
				<thead>
					...
					<tr>
						<th width="3%"></th>
						<th width="3%"></th>
						<th width="10%" colspan="2">Income</th>
						<th width="6%">Jan</th>
						<th width="6%">Feb</th>
						<th width="6%">Mar</th>
						<th width="6%">Apr</th>
							...
							[#if accountSubject.subjectType==1]
								[#if accountSubject.hasChild==1]
									<tr id="traSum" style="background:#E6E6FA;">
										...
										<td style="width:2%;text-align: left;" colspan="${4-accountSubject.level}">${accountSubject.subjectName}</td>
										[#list 1..12 as index]
											<td style="text-align:right;">
												[#list businessFlowList as businessFlow]
													[#if businessFlow.accountDate==index]
														[#if accountSubject.accountSubjectId==businessFlow.accountSubjectId]
															${businessFlow.accountsSum}
															<input type="hidden" value="${businessFlow.accountsSum}" name="sumAmount"/>
														[/#if]	
										...
										[/#list]
										<td id="trtotalSum" style="background-color:#E6E6FA;text-align: right;font-weight:3px;" ></td>
										<td>&nbsp;</td>
									</tr>
								[/#if]
								[#if accountSubject.hasChild==0]
									...
									[/#if]
										...
										<td style="width:2%;text-align: left;"  colspan="${4-accountSubject.level}">${accountSubject.subjectName}</td>
										[#list 1..12 as index]
											<td style="text-align:right;"  class="${index}monthlyForIncome">
												[#list businessFlowList as businessFlow]
													[#if businessFlow.accountDateStr==index]
														[#if accountSubject.accountSubjectId==businessFlow.accountSubjectId]
															${businessFlow.accountsSum}
										...
										[/#list]
										<td class="trtotalSumForIncome" style="background-color:#E6E6FA;text-align: right;font-weight:3px;" >
											<span class="spantrtotalSum"></span><!--Grand Total  -->
											<input class="iptrtotalSum" type="hidden" value=""/>
										</td>
										<td id="" style="background-color:#E6E6FA;text-align: right;"></td>
									</tr>
								[/#if]
							[/#if]
						[/#list]
						<tr id="traSum" style="background-color:#E6E6FA;text-align: right" >
							<td style="width:2%;text-align: left;" colspan="3">
								<input type="hidden" value="true" id="hasChild"/>
							</td>
							<td style="width:2%;text-align: left;" >Total</td>
							[#list 1..12 as index ]
								<td class="${index}totalMonthlyForIncome">
									<span id="${ads}_spantdtotalSum_Cost"></span>
									<input id="${ads}_iptdtotalSum_Cost" type="hidden" value=""/>
								</td>
							[/#list]
							<td id="totalSum_Income" style="background-color:#E6E6FA;text-align: right" ></td>
							<td>100%</td> <!--修改过的地方  -->
						</tr>
					[/#if]
					[#if flag==2||flag==""]
					<thead>
						<tr>
							<td colspan="17">
								<h3 style="text-align:center;magin-bottom:20px;">${year}- Net Cost & Expense Summary ( Jan.- Dec. )</h3>
							</tr>
						</tr>
						<tr>
							<th width="3%"></th>
							<th width="3%"></th>
							<th width="10%" colspan="2">Cost & Expense</th>
							<th width="6%">Jan</th>
							<th width="6%">Feb</th>
							<th width="6%">Mar</th>
							<th width="6%">Apr</th>
						...
						[#if accountSubject.subjectType==2]
							...
							[#if accountSubject.hasChild==0]
								...
								[/#if]
									...
									<td style="width:2%;text-align: left;"  colspan="${4-accountSubject.level}">${accountSubject.subjectName}</td>
									[#list 1..12 as index]
										<td style="text-align:right;"  class="${index}monthlyForCost">
											[#list businessFlowList as businessFlow]
												[#if businessFlow.accountDateStr==index]
													[#if accountSubject.accountSubjectId==businessFlow.accountSubjectId]
														${businessFlow.accountsSum}
									...
									[/#list]
									<td class="trtotalSumForCost" style="background-color:#E6E6FA;text-align: right;font-weight:3px;" >
										<span class="spantrtotalSum"></span><!--Grand Total  -->
										<input class="iptrtotalSum" type="hidden" value=""/>
									</td>
									<td id="" style="background-color:#E6E6FA;text-align: right;"></td>
					...
					<tr id="traSum" style="background-color:#E6E6FA;text-align: right" >
						...
						<td style="width:2%;text-align: left;" >Total</td>
						[#list 1..12 as index ]
							<td class="${index}totalMonthlyForCost">
								<span id="${ads}_spantdtotalSum_Cost"></span>
								<input id="${ads}_iptdtotalSum_Cost" type="hidden" value=""/>
							</td>
						[/#list]
						<td id="totalSum_Cost" style="background-color:#E6E6FA;text-align: right" ></td>
						<td>100%</td> <!--修改过的地方  -->
					</tr>
					[/#if]
			    </tbody>
