                                ...
                                <table class="table table-bordered" id="datatable2">
                                    ...
                                    <tbody id="tbodyContent">
	                                    [#list statisticalProfitList as statisticalProfit]
	                                    	...
	                                    	<tr>
	                                    		<td style="background:#F0FFF0;"><a onclick="showIncomeDetails('${statisticalProfit.deptId}');">${statisticalProfit.jan.income}</a></td>
	                                    		<td style="background:#F0FFF0;"><a onclick="showIncomeDetails('${statisticalProfit.deptId}');">${statisticalProfit.feb.income}</a></td>
	                                    		<td style="background:#F0FFF0;"><a onclick="showIncomeDetails('${statisticalProfit.deptId}');">${statisticalProfit.mar.income}</a></td>
	                                    		<td style="background:#F0FFF0;"><a onclick="showIncomeDetails('${statisticalProfit.deptId}');">${statisticalProfit.apr.income}</a></td>
	                                    		<td style="background:#F0FFF0;"><a onclick="showIncomeDetails('${statisticalProfit.deptId}');">${statisticalProfit.may.income}</a></td>
	                                    		<td style="background:#F0FFF0;"><a onclick="showIncomeDetails('${statisticalProfit.deptId}');">${statisticalProfit.jun.income}</a></td>
	                                    		<td style="background:#F0FFF0;"><a onclick="showIncomeDetails('${statisticalProfit.deptId}');">${statisticalProfit.jul.income}</a></td>
	                                    		<td style="background:#F0FFF0;"><a onclick="showIncomeDetails('${statisticalProfit.deptId}');">${statisticalProfit.aug.income}</a></td>
	                                    		<td style="background:#F0FFF0;"><a onclick="showIncomeDetails('${statisticalProfit.deptId}');">${statisticalProfit.sep.income}</a></td>
	                                    		<td style="background:#F0FFF0;"><a onclick="showIncomeDetails('${statisticalProfit.deptId}');">${statisticalProfit.oct.income}</a></td>
	                                    		<td style="background:#F0FFF0;"><a onclick="showIncomeDetails('${statisticalProfit.deptId}');">${statisticalProfit.nov.income}</a></td>
	                                    		<td style="background:#F0FFF0;"><a onclick="showIncomeDetails('${statisticalProfit.deptId}');">${statisticalProfit.dec.income}</a></td>
	                                    		<td style="background:#F0FFF0;"><a onclick="showIncomeDetails('${statisticalProfit.deptId}');">${statisticalProfit.total.income}</a></td>
	                                    	</tr>
	                                    	<tr style="background:#FFF8DC;">
...
<script type="text/javascript">
    ...
    $("#yearChange").change(function(){
    	year = $("#yearChange").val();
    	$.ajax({
				url:'searchInfoForDeptWithAjax.jhtml?year='+year,
				type:"GET",
	  					...
	  					str+='<tr>'+
							...
							'</tr>'+
	  						'<tr>'+
								...
								'<td style="background:#F0FFF0;"><a onclick="showIncomeDetails(\''+statisticalProfit.deptId+'\');">'+statisticalProfit.nov.income+'</a></td>'+
								'<td style="background:#F0FFF0;"><a onclick="showIncomeDetails(\''+statisticalProfit.deptId+'\');">'+statisticalProfit.dec.income+'</a></td>'+
								'<td class="subTotal" style="background:#F0FFF0;"><a onclick="showIncomeDetails(\''+statisticalProfit.deptId+'\');">'+statisticalProfit.total.income+'</a></td>'+
							'</tr>'+
							'<tr style="background:#FFF8DC;">'+
								'<td><a onclick="showCostDetails(\''+statisticalProfit.deptId+'\');">'+statisticalProfit.jan.cost+'</a></td>'+
								'<td><a onclick="showCostDetails(\''+statisticalProfit.deptId+'\');">'+statisticalProfit.feb.cost+'</a></td>'+
    ...
    function print(){
    	year = $("#yearChange").val();
    	window.location.href="${base}/admin/accountSubject/printSubject.jhtml?year="+year+"&flag=3";
    }
</script>
</body>
</html>
